...
describe('ProjectLearningService', () => {
  it('persists validated project learning and retrieves it for a task', async () => {
    ...
    const learning = new ProjectLearningService('project-1', new MemoryRepository(directory));
    ...
    const restored = new ProjectLearningService('project-1', new MemoryRepository(directory));
